...
Route::group([
    ...
    Route::any('/scheduler/detailmonth', [SchedulerController::class, 'monthviewall'])->name('schedulermonthviewall');
    ...
    Route::any('/scheduler/getschedulerdata', [SchedulerController::class, 'getschedulerdata'])->name('getschedulerdata');
    ...
    Route::any('/report/view/{id}/{address}', [ReportController::class, 'view'])->name('reportview');
