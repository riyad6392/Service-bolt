...
@section('content')
    ...
    <div class="content">
        <div class="row">
                ...
                <a href="{{ url()->previous() }}" class="back-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                        <path fill-rule="evenodd" fill="currentColor"
                              d="M10.78 19.03a.75.75 0 01-1.06 0l-6.25-6.25a.75.75 0 010-1.06l6.25-6.25a.75.75 0 111.06 1.06L5.81 11.5h14.44a.75.75 0 010 1.5H5.81l4.97 4.97a.75.75 0 010 1.06z"></path>
                    </svg>
                    Back</a>
                <div class="side-h3">
                    <h3 class="align-items-center d-flex justify-content-between">Ticket View
                        ...
                        <div>
                            ...
                            <a href="tel:{{$quoteData->phonenumber}}" class="btn btn-dark py-2 px-5">
                                ...
                                Call Customer</a>
                            <a href="{{url('personnel/myticket/map/')}}/{{$quoteData->id}}"
            ...
            <form id="forminout" method="post" class="row" action="{{ route('worker.myticketupdate1') }}"
                ...
                <div class="col-md-7 offset-md-2 ms-auto">
                    ...
                    @if($quoteData->ticket_status=="2")
                        <div class="row w-75" style="position: relative;left: 130px;">
                            <div class="col-lg-6 pick_btn">
                                <button type="submit" class="btn add-btn-yellow mb-4 w-100" name="Pickup"
                                        value="Pickup">Pickup
                                </button>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <input type="button" class="btn add-btn-yellow mb-4 w-100" name="closeout"
                                       value="closeout" style="pointer-events:none;">
                            </div>
                        </div>
                    @endif
                    @if($quoteData->ticket_status=="4")
                        <div class="row w-75" style="position: relative;left: 130px;">
                            <div class="col-lg-6 pick_btn">
                                <button type="submit" class="btn add-btn-yellow mb-4 w-100" name="picked" value="picked"
                                        style="pointer-events:none;">Picked
                                </button>
                            </div>
                            <div class="col-lg-6 pick_btn">
                                <input type="button" id="buttonin" class="btn add-btn-yellow mb-4 w-100" name="closeout"
                                       value="closeout">
                    ...
                    @if($quoteData->ticket_status=="3")
                        <div class="row w-75" style="position: relative;left: 130px;">
                            <div class="col-lg-6 pick_btn">
                                <button type="submit" class="btn add-btn-yellow mb-4 w-100" name="completed"
                                        value="completed" style="pointer-events:none;">Completed
                                </button>
                            </div>
                            @php
        ...
        $sclass="pointer-events: none;background:#fee2002e";
                            ...
                            <div class="col-lg-6">
                                @if($quoteData->payment_mode!="")
                                    <button type="button" class="btn add-btn-yellow mb-4 w-100" name="unclose"
                                            value="unclose" id="unclose"
                                            style="pointer-events: none;background:#fee2002e">Reopen
                                    </button>
                                @else
                                    <button type="button" class="btn add-btn-yellow mb-4 w-100" name="unclose"
                                            value="unclose" id="unclose" style="{{$sclass}}">Reopen
                                    </button>
                                @endif
...
@endphp
                        ...
                        <div class="card-body">
                            <div class="card-content">
                                <h5 class="mb-4 text-center">Ticket Details @if($quoteData->primaryname == $pworkerid)
                                        (Primary)
                                    @endif</h5>
    ...
    if(@$addressnote->notes !=null) {
        ...
        $addressnote = "--";
                                    ...
                                    @if(count($checklistData)>0)
                                        ...
                                        @endphp
                                        <input type="hidden" name="checklistcount" id="checklistcount"
                                               value="{{$ckcount}}">
        ...
        $checkeds = "";
                                            ...
                                            @endphp
                                            <label class="container-checkbox me-3"
                                                   style="color:gray;">{{$value->checklist}}
                                                <input type="checkbox" name="pointckbox[]" id="pointckbox"
                                                       value="{{$value->id}}" {{$checkeds}}> <span
...
<a href="javascript:void(0)" class="btn btn-personnal w-100" onClick="setFocus()">Customer Notes</a>
        ...
        $sclass = "";
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <a class="btn add-btn-yellow w-100" data-bs-toggle="modal"
                                           data-bs-target="#add-tickets" id="editTickets" data-id="{{$quoteData->id}}"
                                           data-price="{{$quoteData->price}}" style="{{$sclass}}">Create Invoice</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
{{--                                <!-- <textarea name="cnotes" class="form-control customer-height mb-4" placeholder="Customer Notes" style="height: 280px;color: gray;">{{$quoteData->note_for_admin}}</textarea> -->--}}
      ...
      $imagelist = explode(',',$quoteData->imagelist);
         ...
         $imgtype= explode('.',strtolower($image));
                                                ...
                                                <div class="col-lg-4 col-sm-4">
                                                    <div class="removediv">
                                                        <div class="images position-relative">
                                                            <a href="{{url('/')}}/uploads/ticketnote/{{$image}}"
                                                               target="_blank">
                                                                <video width="130" height="100" controls>
                                                                    <source src="{{url('/')}}/uploads/ticketnote/{{$image}}"
                                                                            type="video/mp4">
                                                                </video>
                                                            </a>

                                                            <div class="delete-icon">
                                                                <i class="fa fa-trash icon delete"></i><input
                                                ...
                                                <div class="col-lg-4 col-sm-4">
                                                    <div class="removediv">
                                                        <div class="images position-relative">
                                                            <a href="{{url('/')}}/uploads/ticketnote/{{$image}}"
                                                               target="_blank"><img
                                                                        src="{{url('/')}}/uploads/ticketnote/{{$image}}"
                                                                        class="img-fluid"></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        @if($quoteData->frequency == "One Time")
                                            <a href="javascript:void(0)" class="btn add-btn-yellow w-100"
                                               data-bs-toggle="modal" data-bs-target="#ticket-popup" id="ticketpopup"
                                               data-id="{{$quoteData->id}}">Schedule Next Appt.</a>
                                        @else
                                            <a href="javascript:void(0)" class="btn add-btn-yellow w-100"
                                               data-bs-toggle="modal" data-bs-target="#ticket-popup" id="ticketpopup"
                                               data-id="{{$quoteData->id}}"
                                               style="pointer-events: none;background:#fee2002e;">Schedule Next
                                                Appt.</a>
                                        @endif
                                    </div>
            ...
            <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table id="example2" class="table no-wrap table-new table-list align-items-center">
                                ...
                                @foreach($prequoteData as $ticket)
                                    <tr>
                                        <td>
                                            <a href="{{url('personnel/myticket/view/')}}/{{$ticket->id}}">#{{$ticket->id}}</a>
                                        </td>
                ...
                <!-- address model start-->
                <div class="modal fade" id="add-address" tabindex="-1" aria-labelledby="add-customerModalLabel"
        ...
        @csrf -->
                            <div class="modal-body">
                                ...
                                <div class="row customer-form">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <button class="btn btn-cancel btn-block cancelpopup" data-bs-dismiss="modal">
                                            Cancel
                                        </button>
                                    </div>
                                    <div class="col-lg-6 mb-3">
                ...
                <div class="modal fade" id="add-services" tabindex="-1" aria-labelledby="add-personnelModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content customer-modal-box overflow-hidden">
                            <form class="form-material m-t-40 form-valide" method="post" id="serviceformedit"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="add-customer-modal">
                                    ...
                                    <div class="row customer-form" id="product-box-tabs">
                                        ...
                                        <div class="col-md-12 mb-2" style="display: none;">
                                            <div class="d-flex align-items-center">
                                                <select class="selectpicker form-control me-2" multiple
                                                        aria-label="Default select example"
                                                        data-placeholder="Select Products" data-live-search="true"
                                                        name="defaultproduct[]" id="defaultproduct">
                                                ...
                                                <div class="wrapper" style="display: none;">
                                                    ...
                                                    <div class="tooltip">If you are not seeing the products in dropdown
                                                        then add it in inventory section then select here.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="timepicker timepicker1" style="display:inline-block;">
                                                <input type="text" class="hh N" min="0" max="100" placeholder="hh"
                                                       maxlength="2" name="time" id="time"
                                                       onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                                       onpaste="return false">:
                                                <input type="text" class="mm N" min="0" max="59" placeholder="mm"
                                        ...
                                        <div class="col-md-12">
                                            <div style="color: #999999;margin-bottom: 6px;position: relative;">
                                        ...
                                        <div class="col-md-12 mb-2" style="display: none;">
                                            ...
                                            <div class="align-items-center  d-flex services-list"
                                                ...
                                                <label class="container-checkbox me-3">Point 1
                                                    <input type="checkbox" name="pointckbox[]" id="pointckbox"
                                                           value="point1"> <span class="checkmark"></span>
                                                </label>
                                                <label class="container-checkbox me-3">Point 2
                                                    <input type="checkbox" name="pointckbox[]" id="pointckbox"
                                                           value="point2"> <span class="checkmark"></span>
                                                </label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6 mb-2">
                                                <button class="btn btn-cancel btn-block" type="button"
                                                        onClick="refreshPage()">Cancel
                                                </button>
                                            </div>
                                            <div class="col-lg-6">
                                                <button type="submit" class="btn btn-add btn-block">Add a Service
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                ...
                <!-- product modal open -->
                <!-- Modal -->
                <div class="modal fade" id="add-product" tabindex="-1" aria-labelledby="add-personnelModalLabel"
                     aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content customer-modal-box overflow-hidden">
                            <form class="form-material m-t-40 form-valide" method="post" id="productformedit"
                                  enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="add-customer-modal">
                                    ...
                                    <div class="row customer-form" id="product-box-tabs">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <textarea class="form-control height-180" name="description"
                                                      id="description" required="" placeholder="Description"></textarea>
                                        </div>
                                        <div class="col-md-12">
                                            <div style="color: #999999;margin-bottom: 6px;position: relative;">
                                                Approximate Image Size : 285 * 195
    ...
    <form id="form" method="post" action="{{route('worker.sendinvoice')}}">
        @csrf
        <div class="modal fade " id="add-tickets" tabindex="-1" aria-labelledby="add-personnelModalLabel"
    ...
    <form method="post" action="{{route('worker.schedulecreate')}}">
        @csrf
        <div class="modal fade" id="ticket-popup" tabindex="-1" aria-labelledby="add-personnelModalLabel"
             aria-hidden="true">
        ...
        (function (factory) {
            ...
            FileInput.prototype = {
                ...
                _initTemplateDefaults: function () {
                    var self = this, tMain1, tMain2, tPreview, tFileIcon, tClose, tCaption, tBtnDefault, tBtnLink,
                        tBtnBrowse,
                        tModalMain, tModal, tProgress, tSize, tFooter, tActions, tActionDelete, tActionUpload,
                        tActionZoom,
                        tActionDrag, tTagBef, tTagBef1, tTagBef2, tTagAft, tGeneric, tHtml, tImage, tText, tVideo,
                        tAudio,
                    ...
                    self.previewCache = {
                        ...
                        get: function (i, isDisabled) {
                            var ind = 'init_' + i, data = self.previewCache.data, config = data.config[i],
                                content = data.content[i], previewId = self.previewInitId + '-' + ind, out, $tmp, cat,
                                ftr,
                        ...
                        footer: function (i, isDisabled, size) {
                            ...
                            var config = data.config[i], caption = $h.ifSet('caption', config), actions = '',
                                ...
                                showDrag = $h.ifSet('showDrag', config, fs.showDrag),
                ...
                _initZoom: function () {
                    var self = this, $dialog, modalMain = self._getLayoutTemplate('modalMain'),
                        modalId = '#' + $h.MODAL_ID;
                    if (!self.showPreview) {
                        return;
                    }
                    ...
                    self._getThumbs($h.FRAMES + '.file-preview-success').each(function () {
                        ...
                        self._handler($remove, 'click', function () {
                            var id = $thumb.attr('id'),
                                out = self._raise('filesuccessremove', [id, $thumb.data('fileindex')]);
                            $h.cleanMemory($thumb);
                            if (out === false) {
                                return;
                            }
                ...
                _uploadBatch: function () {
                    var self = this, files = self.filestack, total = files.length, params = {}, fnBefore, fnSuccess,
                        fnError,
                    ...
                    fnSuccess = function (data, textStatus, jqXHR) {
                        ...
                        var outData = self._getOutData(jqXHR, data),
                            $thumbs = self._getThumbs(':not(.file-preview-error)'), key = 0,
                ...
                _previewFile: function (i, file, theFile, previewId, data) {
                    ...
                    var self = this, cat = self._parseFileType(file), fname = file ? file.name : '',
                ...
                _setFileDropZoneTitle: function () {
                    var self = this, $zone = self.$container.find('.file-drop-zone'), title = self.dropZoneTitle,
                        strFiles;
                    if (self.isClickable) {
                ...
                _change: function (e) {
                    ...
                    self.fileInputCleared = false;
                    var tfiles = [], msg, total, isDragDrop = arguments.length > 1, isAjaxUpload = self.isUploadable, n,
                        len,
                        files = isDragDrop ? e.originalEvent.dataTransfer.files : $el.get(0).files,
                        ctr = self.filestack.length,
                        isSingleUpload = $h.isEmpty($el.attr('multiple')), flagSingle = (isSingleUpload && ctr > 0),
                        folders = 0, fileIds = self._getFileIds(),
