...
<div class="content">
     <div class="row">
      <div class="col-md-12">
      <div class="side-h3">
       <h3 class="align-items-center d-flex justify-content-between">Pending Quotes 
     </h3>
          ...
          <tbody>
            ...
            @endphp
              <tr>
                ...
                <td>
                  <a class="btn w-auto" data-bs-toggle="modal" data-bs-target="#view-tickets" id="viewTickets" data-id="{{$ticketid}}">View</a>
                </td>
              </tr>
            @endforeach
          </tbody>
