...
">
                                                ...
                                                <td>
                                                    <div class="user-descption d-flex">
                                                        <div class="user-img me-2">
                                                            @if($value->image!=null)
                                                                <img src="{{url('uploads/customer/thumbnail')}}/{{$value->image}}"
                                                                     alt="">
                                                            @else
           ...
           viewBox="0 0 512 512"><path fill="currentColor"
            ...
            <div class="col-md-5 mb-4">
                <div class="card">
                    <div class="card-body">
                        <div class="card-content">
                            <h5 class="mb-4 d-flex align-items-center justify-content-between ref-icon">Inventory Status
                                <a href="">
                   ...
                   fill="currentColor"></path></svg>
                                    ...
                                    <div class="col-6">
                                        <div class="clsoo text-truncate">
                                            @if(!empty($goodproduct[0]))
                                                <h5><a href="{{route('company.inventory')}}" target="_blank"
                                                       style="color:#000;text-decoration:none;">{{$goodproduct[0]}}</a>
                                                </h5>
                                                <p class="mb-2">{{ date('l d, H:i a', time()) }}</p>
                                            @endif
                                            @if(!empty($lowproduct[0]))
                                                <h5><a href="{{route('company.inventory')}}" target="_blank"
                                                       style="color:#000;text-decoration:none;">{{$lowproduct[0]}}</a>
                                                </h5>
                                                <p class="mb-2">{{ date('l d, H:i a', time()) }}</p>
                                            @endif
                                            @if(!empty($restockproduct[0]))
                                                <h5><a href="{{route('company.inventory')}}" target="_blank"
                                                       style="color:#000;text-decoration:none;">{{$restockproduct[0]}}</a>
                                                </h5>
                                                <p class="mb-2"> {{ date('l d, H:i a', time()) }}</p>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        @if(!empty($restockproduct[0]))
                                            <a href="#" class="btn red-light-bg mb-3 " style="width: 125px;">Needs to be
                                                restocked</a>
                                        @endif
                                    </div>
                                </div>
     ...
     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill-rule="evenodd"
                                                                                              fill="currentColor"
                                                                                              d="M4.97 13.22a.75.75 0 000 1.06l6.25 6.25a.75.75 0 001.06 0l6.25-6.25a.75.75 0 10-1.06-1.06l-4.97 4.97V3.75a.75.75 0 00-1.5 0v14.44l-4.97-4.97a.75.75 0 00-1.06 0z"></path></svg>
      </span>
                                </div>
            ...
            <div class="col-md-7 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="mb-4 d-flex align-items-center justify-content-between ref-icon">Personnel Location
                            <a class="livelocationupdate">
                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sync-alt"
                                     class="svg-inline--fa fa-sync-alt fa-w-16" role="img"
                                     xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <path fill="currentColor"
                                    ...
                                    <div class="serices">
                                        <a style="white-space: normal;">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                                ...
                                                <path fill="{{$value->color}}"
                                                      d="M12 18a6 6 0 100-12 6 6 0 000 12z"></path>
...
">
                                    ...
                                    @foreach($ticket as $key =>$value)
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn w-auto" data-bs-toggle="modal"
                                                   data-bs-target="#view-tickets" id="viewTickets"
                                                   data-id="{{$value->id}}">{{$value->id}}</a></td>
                                            <td class="text-truncate"><a class="btn w-auto" data-bs-toggle="modal"
                                                                         data-bs-target="#view-tickets" id="viewTickets"
                                                                         data-id="{{$value->id}}">{{$value->servicename}}</a>
                                            </td>
                                            <td>{{date("m-d-Y", strtotime($value->etc));}}</td>
                                            <td>${{$value->price}}</td>
                                            <td>{{$value->time}} {{$value->minute}}</td>
                                            @if($value->ticket_status == "3")
                                                <td><a class="btn-pending btn-block" data-bs-toggle="modal"
                                                       data-bs-target="#view-tickets" id="viewTickets"
                                                       data-id="{{$value->id}}">Completed</a></td>
                                            @elseif($value->ticket_status == "4")
                                                <td><a class="btn-pending btn-block" data-bs-toggle="modal"
                                                       data-bs-target="#view-tickets" id="viewTickets"
                                                       data-id="{{$value->id}}">Picked</a></td>
                                            @else
                                                <td><a class="btn-pending btn-block" data-bs-toggle="modal"
                                                       data-bs-target="#view-tickets" id="viewTickets"
                                                       data-id="{{$value->id}}">Pending</a></td>
                                            @endif
                            ...
                            @else
                                <div style="text-align: center;position: absolute;top: 50%;left: 38%;">No Record Found
                                </div>
                            @endif
