...
<div class="content">
     ...
     <a href="#"  data-bs-toggle="modal" data-bs-target="#add-term" class="add-btn-yellow">
     Add Term +
     </a>
     </div>
          ...
          <tbody>
           ...
           <tr>
            ...
            <td>
              ...
              <td><a class="btn btn-edit" data-bs-toggle="modal" data-bs-target="#edit-term" id="editTerm" data-id="{{$cdata->id}}">Edit</a>
...
<!-- Modal -->
<div class="modal fade" id="add-term" tabindex="-1" aria-labelledby="add-customerModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content customer-modal-box">
     <form class="form-material m-t-40  form-valide" method="post" action="{{route('company.termscreate')}}" enctype="multipart/form-data">
        @csrf
...
<!----------------------edit form------------>
<div class="modal fade" id="edit-term" tabindex="-1" aria-labelledby="add-personnelModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content customer-modal-box">
      <div class="modal-body">
      <form method="post" action="{{ route('company.termsupdate') }}" enctype="multipart/form-data">
        @csrf
...
$(document).on('click','#editTerm',function(e) {
  $('.selectpicker').selectpicker();
   ...
   $.ajax({
            url:'{{route('company.viewtermmodal')}}',
            data: dataString,
            method: 'post',
            dataType: 'json',
            refresh: true,
        ...
        function (isConfirm) {
          if (isConfirm) {
           $.ajax({
                ...
                refresh: true,
                success:function(data) {
                 swal("Done!","Term deleted succesfully!","success");
                location.reload();
                }
            })
          } 
