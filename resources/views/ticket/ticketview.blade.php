...
@endphp
                                ...
                                <a class="btn add-btn-yellow1 w-40 viewinvoice" data-id="{{$quotedetails[0]->id}}"
                                   data-bs-toggle="modal" data-bs-target="#view-invoice" style="margin-left: 70px;">Invoice</a>
                                <a class="btn add-btn-yellow1 w-40 sendtocustomer" data-bs-toggle="modal"
                                   data-bs-target="#edit-tickets" id="editTickets" data-id="{{$quotedetails[0]->id}}"
                                   data-pid="{{$quotedetails[0]->personnelid}}" data-view="showview"
                                   style="margin-left: 70px;">Edit Invoice</a>
                            </h5>
                            <div class="text-lead mb-3">
                                ...
                                <div class="row" style="background: #eff3f5;padding: 10px;border-radius: 6px;">
                                    <div class="container" style="background: #eff3f5; padding: 10px; border-radius: 6px;">
                                        <table class="table " id="table-borderless" style="table-layout: fixed; width: 100%;">
                                            <tbody>
                                            <tr>
                                                <td style="word-wrap: break-word; white-space: normal;">Start Time :</td>
                                                <td style="word-wrap: break-word; white-space: normal;">{{$quotedetails[0]->giventime}}</td>

                                                    <td style="word-wrap: break-word; white-space: normal;">Company Notes :</td>
                                                    <td style="word-wrap: break-word; white-space: normal;">{!! $quotedetails[0]->description !!}</td>

                                            </tr>
                                            @if($quotedetails[0]->givenendtime!="")
                                                <tr>
                                                    <td style="word-wrap: break-word; white-space: normal;">End Time :</td>
                                                    <td style="word-wrap: break-word; white-space: normal;">{{$quotedetails[0]->givenendtime}}</td>

                                                        <td style="word-wrap: break-word; white-space: normal;">Customer Notes :</td>
                                                        <td style="word-wrap: break-word; white-space: normal;">{!! $quotedetails[0]->customer_notes !!}</td>

                                                </tr>
                                            @endif
                                            <tr>
                                                <td style="word-wrap: break-word; white-space: normal;">Time :</td>
                                                <td style="word-wrap: break-word; white-space: normal;">{{$quotedetails[0]->time}} {{$quotedetails[0]->minute}}</td>
                                                <td style="word-wrap: break-word; white-space: normal;">Payment Status :</td>
                                                <td style="word-wrap: break-word; white-space: normal;">{{$payment_status}}</td>
                                            </tr>
                                            <tr>
                                                <td style="word-wrap: break-word; white-space: normal;">Billing Price :</td>
                                                <td style="word-wrap: break-word; white-space: normal;">${{$quotedetails[0]->price}}</td>

                                                    <td style="word-wrap: break-word; white-space: normal;">Internal Notes :</td>
                                                    <td style="word-wrap: break-word; white-space: normal;">{!! $quotedetails[0]->internal_notes !!}</td>

                                            </tr>
                                            <tr>
                                                <td style="word-wrap: break-word; white-space: normal;">Ticket Total Price :</td>
                                                <td style="word-wrap: break-word; white-space: normal;">${{$quotedetails[0]->tickettotal}}</td>


                                                <td style="word-wrap: break-word; white-space: normal;">Service :</td>
                                                <td style="word-wrap: break-word; white-space: normal;">{{$servicename}}</td>

                                            </tr>
                                            <tr>
                                                <td style="word-wrap: break-word; white-space: normal;">Product :</td>
                                                <td style="word-wrap: break-word; white-space: normal;">{{$productname}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content customer-modal-box">
                        <div class="modal-body">
                            <form class="post-4" method="post" action="{{ route('company.viewinvoice') }}"
                                  enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="ticketid" id="ticketid" value="{{$quotedetails[0]->id}}">
                                <div class="col-md-12">
                                    <div>
                                        <button class="btn add-btn-yellow w-50 viewinvoice" type="submit"
                                                name="invoicetype" value="viewinvoice" target="_blank">View Invoice
                                        </button>
                                    </div>
                            ...
                            <br>
                            <form class="post-4" method="post" action="{{ route('company.downloadinvoiceview') }}"
                                  enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="ticketid" id="ticketid" value="{{$quotedetails[0]->id}}">
                                <div class="col-md-12">
                                    <div>
                                        <button class="btn add-btn-yellow w-50 viewinvoice" type="submit">Download
                                            Invoice
                                        </button>
                                    </div>
                            ...
                            @endphp
                            <form class="post-4" method="post" action="{{ route('company.sendticketinvoice') }}"
                                  enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="ticketid" id="ticketid" value="{{$quotedetails[0]->id}}">
                                ...
                                <div class="col-md-12">
                                    <div>
                                        <a class="btn add-btn-yellow w-50 sendtocustomer" data-email="{{$cinfo->email}}"
                                           data-id="{{$quotedetails[0]->id}}" data-bs-toggle="modal"
                                           data-bs-target="#edit-address">Send to Customer</a>
                                    </div>
