                        ...
                        <div class="card-body">
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-lg-3 text-center mb-2">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#add-tickets"
                                       class="add-btn-yellow btn-block">
                                        Add Quote +
                                    </a>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table no-wrap table-new table-list align-items-center">
                                    ...
                                    <tr>
                                        ...
                                        <th>Action</th>
                                        <div class="heading-dot pull-right" data-bs-toggle="modal"
		        ...
		        $servicename = $servicename->servicename;
                                                        ...
                                                        @if(count($servicedata)>1)
                                                            <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                                                 class="sup-dot service_list_dot"
                                                                 xmlns="http://www.w3.org/2000/svg"
                                                                 data-bs-toggle="modal"
                                                                 data-bs-target="#service-list-dot"
                                                                 id="service_list_dot"
                                                                 data-id="{{ $quote->serviceid }}">
		        ...
		        $servicename = $servicename->servicename;
                                                                ...
                                                                @if(count($servicedata)>1)
                                                                    <svg width="10" height="10" viewBox="0 0 10 10"
                                                                         fill="none" class="sup-dot service_list_dot"
                                                                         xmlns="http://www.w3.org/2000/svg"
                                                                         data-bs-toggle="modal"
                                                                         data-bs-target="#service-list-dot"
                                                                         id="service_list_dot"
                                                ...
                                                @endforeach
                                            @endif
                                            <td><a class="btn btn-dark btn-block btn-lg add-ticket-alert"
                                                   data-id="{{$quote->id}}" style="padding: 7px 0;
    font-size: 16px;
    border-radius: 15px;
    width: 114px!important;
">Ticket +</a></td>
                                            <td><a href="{{url('company/quote/ticketdetail/')}}/{{$quote->id}}"
                                                   class="btn btn-edit p-2 w-auto" target="_blank">View</a><a
                                                        class=" btn btn-edit p-2 w-auto" data-bs-toggle="modal"
                                                        data-bs-target="#edit-tickets" id="editTickets"
                                                        data-id="{{$quote->id}}"
                                                        data-pid="{{$quote->personnelid}}">Edit</a>
                                                <a href="javascript:void(0);" class="info_link1 btn btn-edit p-2 w-auto"
                                                   dataval="{{$quote->id}}">Delete</a>

                                                <a class=" btn btn-edit p-2 w-auto emailinvoice"
                                                   data-id="{{$quote->id}}" data-email="{{$quote->email}}"
                                                   data-bs-toggle="modal" data-bs-target="#edit-address">Share</a>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col-lg-3 col-md-12 text-center mb-2">
                                    <div>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#add-tickets1"
                                           class="add-btn-yellow btn-block">
                                            Add Ticket +
                                        </a></div>
                                </div>
...
//			  		$created_at =  $ticket->ticket_created_date;
//			   } else {
...
//			   }
                                        ...
                                        <tr>
                                            <td>{{$ticket->id}}</td>
                                            <td>{{$ticket->ticket_created_date ?? $ticket->created_at}}</td>
		        ...
		        $servicename = $servicename->servicename;
                                                ...
                                                @endforeach
                                            @endif
                                            <td><a href="{{route('company.scheduler')}}"
                                                   class="btn btn-dark btn-block btn-lg" style="padding: 7px 0;
    font-size: 16px;
    border-radius: 15px;
    width: 114px!important;
">
                                                    ...
                                                    @endif </a></td>
                                            <td>
                                                <a href="{{url('company/quote/ticketdetail/')}}/{{$ticket->id}}"
                                                   class="btn btn-edit p-2 w-auto" target="_blank">View</a>
                                                <a class="btn btn-edit p-2 w-auto" data-bs-toggle="modal"
                                                   data-bs-target="#edit-tickets" id="editTickets"
                                                   data-id="{{$ticket->id}}" data-type="ticket">Edit</a>
                                                <a href="javascript:void(0);" class="info_link1 btn btn-edit p-2 w-auto"
                                                   dataval="{{$ticket->id}}">Delete</a>
                                                <a class=" btn btn-edit p-2 w-auto emailinvoice"
                                                   data-id="{{$ticket->id}}" data-email="{{$ticket->email}}"
                                                   data-bs-toggle="modal" data-bs-target="#edit-address">Share</a>
                                                <a class="btn btn-edit p-2 w-auto repoentoquote"
                                                   data-id="{{$ticket->id}}">Back to quote</a>
                                            </td>
		        ...
		        $servicename = $servicename->servicename;
                                                    ...
                                                    @if(count($servicedata)>1)
                                                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                                             ...
                                                             data-bs-target="#service-list-dot" id="service_list_dot"
                                                             data-id="{{ $ticket->serviceid }}">
                                                            <circle cx="5" cy="5" r="5" fill="#FA8F61"></circle>
                                                        </svg>
                                                    @endif
                                            ...
                                            <td><a class="btn btn-edit p-2 w-auto" data-bs-toggle="modal"
                                                   data-bs-target="#view-tickets" id="viewTickets"
                                                   data-id="{{$ticket->id}}" style="display: none;">View</a>
                                                <a href="{{url('company/quote/ticketdetail/')}}/{{$ticket->id}}"
                                                   class="btn btn-edit p-2 w-auto" target="_blank">View</a>
                                                @if($ticket->payment_status==null || $ticket->payment_mode==null)
                                                    <a class="btn btn-edit p-2 w-auto" data-bs-toggle="modal"
                                                ...
                                                @if($ticket->payment_mode==null && $invoice_status == "Not Invoiced")
                                                    <a class="btn btn-edit p-2 w-auto repoenticket"
                                                       data-id="{{$ticket->id}}">Reopen</a>
                                                @endif
                                            </td>
                                        </tr>
                                        @php
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content customer-modal-box">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-material m-t-40 row form-valide" method="post"
                          action="{{route('company.quotecreate')}}" enctype="multipart/form-data">
                        @csrf
                        @php
                            if(count($customer)>0) {
	 			$custmername = "";
                        ...
                        <div class="row customer-form">
                            <div class="col-md-11 mb-2">
                                <div class="input_fields_wrap">
                                    <div class="mb-3">
                                        <select class="form-select {{$custmername}}" name="customerid" id="customerid"
                                                required>
                                            <option selected="" value="">Select a customer or Begin Typing a Name
                                            </option>
                                        ...
                                        <div class="d-flex align-items-center justify-content-end pe-3 mt-3">
                                            <a class="addanew" href="#" data-bs-toggle="modal"
                                               data-bs-target="#add-customer" class="" id="hidequote"><i
                                                        class="fa fa-plus first"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <select class="selectpicker form-control {{$cname}}" name="servicename[]"
                                    ...
                                    @foreach($services as $key =>$value)
                                        <option value="{{$value->id}}" data-hour="{{$value->time}}"
                                                data-min="{{$value->minute}}" data-price="{{$value->price}}"
                                                data-frequency="{{$value->frequency}}">{{$value->servicename}}</option>
                                    @endforeach
                                </select>
                                <div class="d-flex align-items-center justify-content-end pe-3 mt-3">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#add-services" class=""
                                       id="hidequoteservice"><i class="fa fa-plus second"></i></a>
                                </div>
                            </div>

                            <div class="col-md-11 mb-3">
                                <select class="selectpickerp1 form-control {{$cname}}" name="productname[]"
                                        id="productname" multiple aria-label="Default select example"
                                        data-live-search="true" data-placeholder="Select Products" class="productclass">
                                ...
                                <div class="d-flex align-items-center justify-content-end pe-3 mt-3">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#add-products" class=""
                                       id="hidequoteproduct"><i class="fa fa-plus third"></i></a>
                                </div>
                            </div>
		    ...
		    $end   = (strtotime($maxtime));
                            ...
                            <div class="form-group col-md-6 mb-3 time" style="display:none;">
                                ...
                                <select class="form-control selectpicker" aria-label="Default select example"
                                        data-placeholder="Select Time" data-live-search="true" name="giventime"
                                        id="timedefault1" style="height:auto;">
                            ...
                            <div class="col-md-6 mb-3 date" style="display:none;">
                                ...
                                <input type="text" class="form-control etc" placeholder="mm/dd/yyyy" name="date"
                                       id="date1" onkeydown="return false" style="position: relative;">
                            </div>

                            <div class="col-md-12 mb-3">
                                <div class="align-items-center justify-content-lg-between d-flex services-list">
                                    <label class="container-checkbox">Per hour
                                        <input type="radio" id="test11" name="radiogroup" value="perhour"
                                               class="radiogroupforquote" checked>
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="container-checkbox">Flate rate
                                        <input type="radio" id="test22" name="radiogroup" value="flatrate"
                                               class="radiogroupforquote">
                                        <span class="checkmark"></span>
                                    </label>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select class="form-select" name="frequency" id="frequency" required="">
                                    ...
                                    @foreach($tenture as $key=>$value)
                                        <option name="{{$value->tenturename}}"
                                                value="{{$value->tenturename}}">{{$value->tenturename}}</option>
                                    @endforeach
          ...
          <option name="Monthly" value="Monthly">Monthly</option> -->
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="timepicker timepicker1 form-control"
                                     style="display: flex;align-items: center;">
                                    <input type="text" class="hh N popfields" min="0" max="100" placeholder="hh"
                                           maxlength="2" name="time" id="time"
                                           onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                           onpaste="return false">:
                                    <input type="text" class="mm N popfields" min="0" max="59" placeholder="mm"
                                           maxlength="2" name="minute" id="minute"
                                           onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                           onpaste="return false">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-3 position-relative">
                                ...
                                <input type="text" class="form-control" placeholder="Price" name="price" id="price"
                                       ...
                                       onpaste="return false" style="padding: 0 35px;" required="">
                                <input type="hidden" name="hiddenprice" id="hiddenprice">
                            </div>

                            <div class="col-md-12 mb-3">
                                <label style="position: relative;left: 12px;margin-bottom: 11px;">ETC</label>
                                <input type="text" class="form-control etc" placeholder="mm/dd/yyyy" name="etc" id="etc"
                                       onkeydown="return false" style="position: relative;" required>
                            </div>
                            <div class="col-md-12 mb-3">
                                <textarea class="form-control height-180" placeholder="Company Notes" name="description"
                            ...
                            <div class="col-lg-6 mb-3">
                                <button type="submit" class="btn btn-add btn-block" type="submit" name="quote"
                                        value="quote">Add a Quote
                                </button>
                            </div>
    ...
    <div class="modal fade" id="add-tickets1" tabindex="-1" aria-labelledby="add-personnelModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content customer-modal-box">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-material m-t-40 row form-valide" method="post"
                          action="{{route('company.ticketcreate')}}" enctype="multipart/form-data">
                        @csrf
                        @php
                            if(count($customer)>0) {
	 			$custmername = "";
	 			...
	 			$custmername = "active-focus";
                        ...
                        <div class="row customer-form">
                            <div class="col-md-12 mb-2">
                                <div class="input_fields_wrap">
                                    <div class="mb-3">
                                        <select class="form-select {{$custmername}}" name="customerid" id="customerid1"
                                                required>
                                            <option selected="" value="">Select a customer or Begin Typing a Name
                                            </option>
                                            @foreach($customer as $key => $value)
                                        ...
                                        <div class="d-flex align-items-center justify-content-end pe-3 mt-3">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#add-customer2" class=""
                                               id="hideticket"><i class="fa fa-plus first-one"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
	 		...
	 		if(count($worker)>0) {
	 			...
	 			$wname = "active-focus";
                            ...
                            <div class="col-md-11 mb-3">
                                ...
                                <div class="d-flex align-items-center justify-content-end pe-3 mt-3">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#add-services1" class=""
                                       id="hidequoteservice2"><i class="fa fa-plus next-one"></i></a>
                                </div>
                            </div>

                            <div class="col-md-11 mb-3">
                                <select class="selectpickert1 form-control {{$cname}}" name="productname[]"
                                        id="productnamet1" multiple aria-label="Default select example"
                                        data-live-search="true" data-placeholder="Select Products">
                                    @foreach($productData as $key =>$value)
                                        <option value="{{$value->id}}"
                                                data-price="{{$value->price}}">{{$value->productname}}</option>
                                    @endforeach
                                ...
                                <div class="d-flex align-items-center justify-content-end pe-3 mt-3">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#add-products1" class=""
                                       id="hidequoteservice2"><i class="fa fa-plus next-two"></i></a>
                                </div>
                            </div>
        ...
        $end   = (strtotime($maxtime));
                            ...
                            <div class="form-group col-md-6 mb-3 time" style="display:none;">
                                ...
                                <select class="form-control selectpicker" aria-label="Default select example"
                                        data-placeholder="Select Time" data-live-search="true" name="giventime"
                                        id="timedefault" style="height:auto;">
                                    @for( $i = $start; $i <= $end; $i += $inc)
                                        @php
                                            $range = date( 'h:i a', $i);
                                        @endphp
                            ...
                            <div class="col-md-6 mb-3 date" style="display:none;">
                                <label style="position: relative;left: 12px;margin-bottom: 11px;">Date</label>
                                <input type="text" class="form-control etc" placeholder="mm/dd/yyyy" name="date"
                                       id="date" onkeydown="return false" style="position: relative;">
                            </div>
                            <div class="col-md-12 mb-3">
                                <div class="align-items-center justify-content-lg-between d-flex services-list">
                                    <label class="container-checkbox">Per hour
                                        <input type="radio" id="test111" name="radiogroup" class="radiogroupforticket"
                                               value="perhour" checked>
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="container-checkbox">Flate rate
                                        <input type="radio" id="test222" name="radiogroup" class="radiogroupforticket"
                                               value="flatrate">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="container-checkbox">Reccuring
                                        <input type="radio" id="test333" name="radiogroup" class="radiogroupforticket"
                                               value="recurring">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="timepicker timepicker1 form-control"
                                     style="display: flex;align-items: center;">
                                    <input type="text" class="hh N popfields1" min="0" max="100" placeholder="hh"
                                           maxlength="2" name="time" id="time1"
                                           onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                           onpaste="return false">:
                                    <input type="text" class="mm N popfields1" min="0" max="59" placeholder="mm"
                                           maxlength="2" name="minute" id="minute1"
                                           onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                           onpaste="return false">
                                </div>
                            </div>
    ...
    margin: 18px;"></i>
                                <input type="text" class="form-control" placeholder="Price" name="price" id="price1"
                                       onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46 || event.charCode == 0"
                                       onpaste="return false" style="padding: 0 35px;" required="">
                            ...
                            <div class="col-md-12 mb-3">
                                <label style="position: relative;left: 12px;margin-bottom: 11px;">ETC</label>
                                <input type="text" value="" class="form-control etc" placeholder="mm/dd/yyyy" name="etc"
                                       id="etc1" onkeydown="return false" style="position: relative;" required>
                            </div>
                            <div class="col-md-12 mb-3">
                                <textarea class="form-control height-180" placeholder="Company Notes" name="description"
                                          id="description" required></textarea>
                            ...
                            <div class="col-lg-6 mb-3">
                                <button type="submit" class="btn btn-add btn-block" name="ticket" value="ticket">Add a
                                    Ticket
                                </button>
                            </div>
    ...
    <div class="modal fade" id="view-tickets" tabindex="-1" aria-labelledby="add-personnelModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content customer-modal-box">
                <div class="modal-body">
            ...
            <div class="modal-content">
                ...
                ->where('page','companyquote')->where('userid',$auth_id)->where('columname',$value)->first();
                                                ...
                                                @if($value=="customername" || $value=="frequency" || $value=="price" || $value=="servicename")
                                                    <li><label> <input type="checkbox" class="checkcolumn me-2"
                                                                       name="checkcolumn[]"
                                                                       value="{{$value}}" {{ (@$pagedata->columname) == $value ? 'checked' : '' }}>{{quote_filter($value)}}
                                                        </label></li>
            ...
            <div class="modal-content">
                ...
                ->where('page','companyticket')->where('columname',$value)->where('userid',$auth_id)->first();
                                                ...
                                                @if($value=="customername" || $value=="frequency" || $value=="price" || $value=="servicename")
                                                    <li><label> <input type="checkbox" class="checkcolumn me-2"
                                                                       name="checkcolumn[]"
                                                                       value="{{$value}}" {{ (@$pagedata1->columname) == $value ? 'checked' : '' }}>{{quote_filter($value)}}
                                                        </label></li>
    ...
    <div class="modal fade" id="service-list-dot" tabindex="-1" aria-labelledby="add-customerModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content customer-modal-box">
            ...
            <div class="modal-content customer-modal-box  overflow-hidden">
                <div class="modal-body">
                    ...
                    <div class="row customer-form">
                        ...
                        <div class="col-md-12 mb-3">
                            <input type="text" class="form-control" placeholder="Search Addresses" name="address"
                                   id="address5" required="">
                            <div class="find_msg" style="display:none;"></div>
                        </div>

                        <div class="col-lg-6 mb-3">
                            <button class="btn btn-cancel btn-block" data-bs-dismiss="modal" aria-label="Close"
                                    id="quotecancel12">Cancel
                            </button>
                        </div>
                        <div class="col-lg-6 mb-3">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content customer-modal-box  overflow-hidden">
                <div class="modal-body">
                    ...
                    <div class="add-customer-modal d-flex justify-content-between align-items-center">
                        <h5>Add Address</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" id="ticketcancel1"
                    ...
                    <div class="row customer-form">
                        ...
                        <div class="col-md-12 mb-3">
                            <input type="text" class="form-control" placeholder="Search Addresses" name="address"
                                   id="address6" required="">
                            <div class="find_msg" style="display:none;"></div>
                        </div>

                        <div class="col-lg-6 mb-3">
                            <button class="btn btn-cancel btn-block" data-bs-dismiss="modal" id="ticketcancel12">
                                Cancel
                            </button>
                        </div>
                        <div class="col-lg-6 mb-3">
    ...
    <div class="modal fade" id="add-customer" tabindex="-1" aria-labelledby="add-customerModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content customer-modal-box  overflow-hidden">
                <form class="form-material m-t-40  form-valide" method="post" id="createserviceticket"
                    ...
                    <div class="modal-body">
                        <div class="add-customer-modal d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="btn-close" id="quotecancel" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                        </div>
                        ...
                        <div class="row customer-form">
                            ...
                            <div class="col-md-12 mb-3" style="display:none;">
                                <div class="d-flex align-items-center">
                                    <select class="selectpicker form-control" multiple
                                            aria-label="Default select example" data-live-search="true"
                                            name="productid[]" id="productid" data-placeholder="Select Products">
                            ...
                            <div class="col-lg-12 mb-3">
                                <div style="color: #999999;margin-bottom: 6px;position: relative;left: 10px;">
                                    Approximate Image Size : 285 * 195
                                </div>
                                <div class="drop-zone">
    <span class="drop-zone__prompt text-center">
  <small><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
              class="feather feather-upload"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline
                  points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg></small>
  Drop file here or click to upload</span>
                            ...
                            <div class="col-lg-6 mb-3">
                                <button class="btn btn-cancel btn-block" data-bs-dismiss="modal" id="quotecancel_1">
                                    Cancel
                                </button>
                            </div>
                            <div class="col-lg-6 mb-3">
    ...
    <!-- Add customer2 modal -->
    <div class="modal fade" id="add-customer2" tabindex="-1" aria-labelledby="add-customerModalLabel" aria-hidden="true"
         data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content customer-modal-box  overflow-hidden">
                <form class="form-material m-t-40  form-valide" method="post" id="createserviceticket1"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="add-customer-modal d-flex justify-content-between align-items-center">
                            <h5>Add a new customer</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" id="ticketcancel"
                                    aria-label="Close"></button>
                        </div>
  ...
  Drop file here or click to upload</span>
                            ...
                            <div class="col-lg-6 mb-3">
                                <button class="btn btn-cancel btn-block" data-bs-dismiss="modal"
                                        id="ticketcancelcustomer">Cancel
                                </button>
    ...
    <!-- end modal -->
    <!-- Modal -->
    <div class="modal fade" id="add-services" tabindex="-1" aria-labelledby="add-personnelModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content customer-modal-box overflow-hidden">
                <form class="form-material m-t-40 form-valide" id="serviceform" method="post"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="add-customer-modal d-flex justify-content-between align-items-center">
                            <h5>Add a new Service</h5>
                            <button type="button" class="btn-close" id="quotecancel3" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                        </div>
                        @php
            ...
            $pname= "active-focus";
                        ...
                        <div class="row customer-form" id="product-box-tabs">
                            ...
                            <div class="col-md-12 mb-2 position-relative">
                                ...
                                <input type="text" class="form-control" placeholder="Service Default Price" name="price"
                                       id="price10"
                                       onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46 || event.charCode == 0"
                                       onpaste="return false" style="padding: 0 35px;" required="">
                            </div>
                            <div class="col-md-12 mb-2">
                                <div class="d-flex align-items-center">
                                    <select class="selectpicker form-control me-2 {{$pname}}" multiple
                                            aria-label="Default select example" data-placeholder="Select Products"
                                            data-live-search="true" name="defaultproduct[]" id="defaultproduct">
                                    ...
                                    <div class="wrapper" style="display: none;">
                                        ...
                                        <div class="tooltip">If you are not seeing the products in dropdown then add it
                                            in inventory section then select here.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-2">
                                <div class="align-items-center justify-content-lg-between d-flex services-list">
                                    <p>
                                        <input type="radio" id="test1" name="radiogroup" value="perhour"
                                               class="radiogrp" checked>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="timepicker timepicker1" style="display:inline-block;">
                                    <input type="text" class="hh N" min="0" max="100" placeholder="hh" maxlength="2"
                                           name="time" id="time10"
                                           onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                           onpaste="return false">:
                                    <input type="text" class="mm N" min="0" max="59" placeholder="mm" maxlength="2"
                                           name="minute" id="minute10"
                                           onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                           onpaste="return false">
                                </div>
                            </div>
              ...
              <label for="colorPicker">
                <input type="color" value="#faed61" id="colorPicker" name="colorcode" style="width:235px;">
                            ...
                            <div class="col-md-12">
                                <div style="color: #999999;margin-bottom: 6px;position: relative;">Approximate Image
                                    Size : 285 * 195
                                </div>
                                <input type="file" class="dropify" name="image" id="image" data-max-file-size="2M"
                                       data-allowed-file-extensions='["jpg", "jpeg","png","gif","svg","bmp"]'
                                       accept="image/png, image/gif, image/jpeg, image/bmp, image/jpg, image/svg">
                            </div>
                            <div class="col-md-12 mb-2" style="display: none;">
                                ...
                                <div class="align-items-center  d-flex services-list" style="flex-flow:wrap;">
                                    <label class="container-checkbox me-3">Point 1
                                        <input type="checkbox" name="pointckbox[]" id="pointckbox" value="point1"> <span
                                                class="checkmark"></span>
                                    </label>
                                    <label class="container-checkbox me-3">Point 2
                                        <input type="checkbox" name="pointckbox[]" id="pointckbox" value="point2"> <span
                                                class="checkmark"></span>
                                    </label>
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6 mb-2">
                                    <button type="button" class="btn btn-cancel btn-block" id="quotecancel31"
    ...
    <!-- product Modal -->
    <div class="modal fade" id="add-products" tabindex="-1" aria-labelledby="add-personnelModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content customer-modal-box overflow-hidden">
                <form class="form-material m-t-40 form-valide" id="productform" method="post"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="add-customer-modal d-flex justify-content-between align-items-center">
                        ...
                        <div class="row customer-form" id="product-box-tabs">
                            <div class="col-md-12 mb-3">
                                <input type="text" class="form-control" placeholder="Product/Part Name"
                            ...
                            <div class="col-md-12 mb-3">
                                <select class="selectpicker form-control" multiple aria-label="Default select example"
                                        data-live-search="true" name="serviceid[]" id="serviceid">
                                    @foreach ($services as $service)
                                        <option value="{{$service->id}}">{{$service->servicename}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Preferred Quantity"
                                       name="pquantity" id="pquantity" required=""
                                       onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57">
                            ...
                            <div class="col-lg-12 mb-3">
                                <textarea class="form-control height-180" name="description" id="description"
    ...
    <!-- product1 Modal -->
    <div class="modal fade" id="add-products1" tabindex="-1" aria-labelledby="add-personnelModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content customer-modal-box overflow-hidden">
                <form class="form-material m-t-40 form-valide" id="productform1" method="post"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="add-customer-modal d-flex justify-content-between align-items-center">
    ...
    <div class="modal fade" id="add-services1" tabindex="-1" aria-labelledby="add-personnelModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content customer-modal-box overflow-hidden">
                <form class="form-material m-t-40 form-valide" id="serviceform1" method="post"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="add-customer-modal d-flex justify-content-between align-items-center">
            ...
            $pname= "active-focus";
                        ...
                        <div class="row customer-form" id="product-box-tabs">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="align-items-center justify-content-lg-between d-flex services-list">
                                    <p>
                                        <input type="radio" id="tickerservice1" name="radiogroup" value="perhour"
                                               class="radio" checked>
                                        <label for="tickerservice1">Per Hour</label>
                                    </p>
                                    <p>
                                        <input type="radio" id="tickerservice2" name="radiogroup" value="flatrate"
                                               class="radio">
                                        <label for="tickerservice2">Flate Rate</label>
                                    </p>
                                    <p>
                                        <input type="radio" id="tickerservice3" name="radiogroup" value="recurring"
                                               class="radio">
              ...
              <label for="colorPicker">
                <input type="color" value="#faed61" id="colorPicker" name="colorcode" style="width:235px;">
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-6 mb-2">
                                    <button class="btn btn-cancel btn-block" id="quotecancel41" data-bs-dismiss="modal">
                                        Cancel
                                    </button>
                                </div>
                                <div class="col-lg-6">
