                            ...
                            <div class="text-lead mb-3">
                                ...
                                <div class="row" style="background: #eff3f5;padding: 10px;border-radius: 6px;">
                                    ...
                                    @if($productname!="")
                                        <div class="col-md-6">
                                            <div>
                                                <p>Product: {{$productname}}</p></div>
                                        </div>
                                    @endif
                                    <div class="col-md-6">
                                        <div>
                                            <p>@if($quotedetails[0]->description!="")
                                                    Ticket Description: {{$quotedetails[0]->description}}
                                                @endif</p></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div>
                                            <p>@if($addressnote->notes!=null)
                                                    Address Notes: {{$addressnote->notes}}
                                                @endif</p>
                                        </div>
                                    </div>
