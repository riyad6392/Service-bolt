  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content customer-modal-box">
     ...
     @foreach($customerAddress as $key=>$value)
        ...
        <a class="btn btn-save confirm me-2" data-bs-toggle="modal" data-bs-target="#create-ctickets" id="createctickets" data-id="{{$value->customerid}}" data-address="{{$value->address}}" style="width:152px;">Create Ticket</a>
