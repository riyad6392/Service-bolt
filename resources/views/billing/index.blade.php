...
<div class="card">
      ...
      @else
        @foreach($pagedata as $key => $pagecolumn)
          ...
          @if($pagecolumn->columname=="customername")
            <th>Customer</th>
          @endif
          @if($pagecolumn->columname=="payment_status")
            <th>Status</th>
          @endif
        @endforeach
      @endif
      <div class="col-sm-1 col-xs-1  heading-dot pull-right" data-bs-toggle="modal" data-bs-target="#exampleModal">    
    ...
    @endforeach</td>
        ...
        <td><a href="#" class="btn-completed btn-common">
