...
$validateData = $request->validate([
    ...
    //'new_password' => 'min:8|required_with:password_confirmation|same:change_password|regex:/^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{6,}$/',
    'new_password' => 'min:8|different:old_password|required_with:password_confirmation|same:change_password|regex:/[@$!%*#?&]/',
