...
class ComissionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        @$from = $request->since;
        @$to = $request->until;
        return view('report.commission',compact('auth_id','pdata','tickedata','percentall','amountall','tickedatadetails','personnelid','comisiondataamount','comisiondatapercent','currentdate','from','to'));
    }
}
